...
public class AdminController {
    ...
    public String getDashboardReport(Model model) throws JsonProcessingException {
        // Reuse logic from dashboard to fetch stats
        ...
        model.addAttribute("monthlySalesCount", monthlySalesCount);
        model.addAttribute("yearlySales", yearlySales);
        model.addAttribute("yearlySalesCount", yearlySalesCount);

        return "admin/dashboard-report";
    }
